...
const gdprText = (
  <div>
    ...
    <p>
      Lawful Basis for Processing: We collect and process personal data based on
      one or more lawful bases defined in the GDPR, such as consent, contract
      performance, legal obligation, vital interests, public task, or legitimate
      interests.
    </p>
    ...
    <p>
      ...
      contact information, IP addresses, and any other information voluntarily
    ...
    <p>
      ...
      services, improving our website, communicating with users, responding to
      inquiries, complying with legal obligations, and sending marketing
    ...
    <p>
      ...
      retention period is required or permitted by law. We regularly review the
      data we hold and delete or anonymize data that is no longer necessary.
    </p>

    <p>
      Data Sharing: We may share personal data with trusted third-party service
      providers or business partners who assist us in delivering our services or
      as required by law. We ensure that such third parties provide sufficient
      guarantees to protect the personal data in compliance with the GDPR.
    </p>

    <h3>User Rights</h3>

    <p>
      Right to Access: Users have the right to request access to their personal
      data and receive information about how it is processed.
    </p>

    <p>
      Right to Rectification: Users have the right to request the correction or
      update of inaccurate or incomplete personal data.
    </p>

    <p>
      Right to Erasure: Users have the right to request the deletion of their
      personal data under certain circumstances, such as when the data is no
    ...
    <p>
      ...
      restriction of processing their personal data under certain circumstances.
    </p>

    <p>
      Right to Data Portability: Users have the right to receive a copy of their
      personal data in a structured, commonly used, and machine-readable format
      and to transmit it to another controller.
    </p>

    <p>
      Right to Object: Users have the right to object to the processing of their
      personal data based on legitimate interests or for direct marketing
      purposes.
    </p>
    ...
    <p>
      ...
      contact us using the information provided on the <b>Contact</b> section on
      the website.
    </p>
  </div>
);
